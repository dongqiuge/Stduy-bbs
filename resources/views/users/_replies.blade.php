@if (count($replies))
    ...
    <ul class="list-group mt-4 border-0">
        @foreach ($replies as $reply)
            <li class="list-group-item pl-2 pr-2 border-right-0 border-left-0 @if($loop->first) border-top-0 @endif @if($loop->last) border-bottom-0 @endif"
                style="border-left: 0; border-right: 0; !important;">
